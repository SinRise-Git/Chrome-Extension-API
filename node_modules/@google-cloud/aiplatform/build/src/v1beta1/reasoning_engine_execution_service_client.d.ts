 ...
 * @memberof v1beta1
 */
export declare class ReasoningEngineExecutionServiceClient {
    private _terminated;
    private _opts;
    ...
    reasoningEngineExecutionServiceStub?: Promise<{
        [name: string]: Function;
    }>;
    /**
     * Construct an instance of ReasoningEngineExecutionServiceClient.
     *
     ...
     *     const client = new ReasoningEngineExecutionServiceClient({fallback: true}, gax);
     *     ```
     */
     ...
     * @param {google.protobuf.Struct} [request.input]
     ...
     *   The first element of the array is an object representing {@link protos.google.cloud.aiplatform.v1beta1.QueryReasoningEngineResponse|QueryReasoningEngineResponse}.
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v1beta1/reasoning_engine_execution_service.query_reasoning_engine.js</caption>
     * region_tag:aiplatform_v1beta1_generated_ReasoningEngineExecutionService_QueryReasoningEngine_async
     */
    queryReasoningEngine(request?: protos.google.cloud.aiplatform.v1beta1.IQueryReasoningEngineRequest, options?: CallOptions): Promise<[
        protos.google.cloud.aiplatform.v1beta1.IQueryReasoningEngineResponse,
        (protos.google.cloud.aiplatform.v1beta1.IQueryReasoningEngineRequest | undefined),
        {} | undefined
    ]>;
    queryReasoningEngine(request: protos.google.cloud.aiplatform.v1beta1.IQueryReasoningEngineRequest, options: CallOptions, callback: Callback<protos.google.cloud.aiplatform.v1beta1.IQueryReasoningEngineResponse, protos.google.cloud.aiplatform.v1beta1.IQueryReasoningEngineRequest | null | undefined, {} | null | undefined>): void;
    queryReasoningEngine(request: protos.google.cloud.aiplatform.v1beta1.IQueryReasoningEngineRequest, callback: Callback<protos.google.cloud.aiplatform.v1beta1.IQueryReasoningEngineResponse, protos.google.cloud.aiplatform.v1beta1.IQueryReasoningEngineRequest | null | undefined, {} | null | undefined>): void;
    /**
