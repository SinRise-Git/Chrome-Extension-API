...
exports.ReasoningEngineExecutionServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta1/reasoning_engine_execution_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./reasoning_engine_execution_service_client_config.json");
...
class ReasoningEngineExecutionServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1beta1.ReasoningEngineExecutionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.reasoningEngineExecutionServiceStub) {
            return this.reasoningEngineExecutionServiceStub;
        }
        // Put together the "service stub" for
        // google.cloud.aiplatform.v1beta1.ReasoningEngineExecutionService.
        this.reasoningEngineExecutionServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1beta1.ReasoningEngineExecutionService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.aiplatform.v1beta1
                    .ReasoningEngineExecutionService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of reasoningEngineExecutionServiceStubMethods) {
            const callPromise = this.reasoningEngineExecutionServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    queryReasoningEngine(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
...
//# sourceMappingURL=reasoning_engine_execution_service_client.js.map