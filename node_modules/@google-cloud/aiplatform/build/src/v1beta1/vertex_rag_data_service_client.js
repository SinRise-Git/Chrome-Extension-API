...
exports.VertexRagDataServiceClient = void 0;
 ...
 */
const gapicConfig = require("./vertex_rag_data_service_client_config.json");
 ...
 * @memberof v1beta1
 */
class VertexRagDataServiceClient {
    /**
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listRagCorpora: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'ragCorpora'),
            listRagFiles: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'ragFiles'),
        };
        ...
        const createRagCorpusResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.RagCorpus');
        const createRagCorpusMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.CreateRagCorpusOperationMetadata');
        const deleteRagCorpusResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteRagCorpusMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeleteOperationMetadata');
        const importRagFilesResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.ImportRagFilesResponse');
        const importRagFilesMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.ImportRagFilesOperationMetadata');
        const deleteRagFileResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteRagFileMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeleteOperationMetadata');
        this.descriptors.longrunning = {
            createRagCorpus: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createRagCorpusResponse.decode.bind(createRagCorpusResponse), createRagCorpusMetadata.decode.bind(createRagCorpusMetadata)),
            deleteRagCorpus: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteRagCorpusResponse.decode.bind(deleteRagCorpusResponse), deleteRagCorpusMetadata.decode.bind(deleteRagCorpusMetadata)),
            importRagFiles: new this._gaxModule.LongrunningDescriptor(this.operationsClient, importRagFilesResponse.decode.bind(importRagFilesResponse), importRagFilesMetadata.decode.bind(importRagFilesMetadata)),
            deleteRagFile: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteRagFileResponse.decode.bind(deleteRagFileResponse), deleteRagFileMetadata.decode.bind(deleteRagFileMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1beta1.VertexRagDataService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.vertexRagDataServiceStub) {
            return this.vertexRagDataServiceStub;
        }
        // Put together the "service stub" for
        // google.cloud.aiplatform.v1beta1.VertexRagDataService.
        this.vertexRagDataServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1beta1.VertexRagDataService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.aiplatform.v1beta1
                    .VertexRagDataService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of vertexRagDataServiceStubMethods) {
            const callPromise = this.vertexRagDataServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getRagCorpus(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
    ...
    uploadRagFile(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    getRagFile(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    createRagCorpus(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkCreateRagCorpusProgress(name) {
    ...
    deleteRagCorpus(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkDeleteRagCorpusProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    importRagFiles(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkImportRagFilesProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    deleteRagFile(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkDeleteRagFileProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    listRagCorpora(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     *   for more details and examples.
     */
    listRagCorporaStream(request, options) {
        var _a;
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        ...
        this.initialize();
        return this.descriptors.page.listRagCorpora.createStream(this.innerApiCalls.listRagCorpora, request, callSettings);
    }
    /**
     ...
     */
    listRagCorporaAsync(request, options) {
        var _a;
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listRagCorpora.asyncIterate(this.innerApiCalls['listRagCorpora'], request, callSettings);
    }
    listRagFiles(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     *   for more details and examples.
     */
    listRagFilesStream(request, options) {
        var _a;
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listRagFiles.createStream(this.innerApiCalls.listRagFiles, request, callSettings);
    }
    /**
     ...
     */
    listRagFilesAsync(request, options) {
        var _a;
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listRagFiles.asyncIterate(this.innerApiCalls['listRagFiles'], request, callSettings);
    }
    /**
...
//# sourceMappingURL=vertex_rag_data_service_client.js.map