...
class PersistentResourceServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const rebootPersistentResourceResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.PersistentResource');
        const rebootPersistentResourceMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.RebootPersistentResourceOperationMetadata');
