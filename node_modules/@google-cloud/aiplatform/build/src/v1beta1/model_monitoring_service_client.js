...
exports.ModelMonitoringServiceClient = void 0;
 ...
 */
const gapicConfig = require("./model_monitoring_service_client_config.json");
...
class ModelMonitoringServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listModelMonitors: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'modelMonitors'),
            listModelMonitoringJobs: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'modelMonitoringJobs'),
            searchModelMonitoringStats: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'monitoringStats'),
            searchModelMonitoringAlerts: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'modelMonitoringAlerts'),
        };
        ...
        const createModelMonitorResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.ModelMonitor');
        const createModelMonitorMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.CreateModelMonitorOperationMetadata');
        const updateModelMonitorResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.ModelMonitor');
        const updateModelMonitorMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.UpdateModelMonitorOperationMetadata');
        const deleteModelMonitorResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteModelMonitorMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeleteOperationMetadata');
        const deleteModelMonitoringJobResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteModelMonitoringJobMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeleteOperationMetadata');
        this.descriptors.longrunning = {
            createModelMonitor: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createModelMonitorResponse.decode.bind(createModelMonitorResponse), createModelMonitorMetadata.decode.bind(createModelMonitorMetadata)),
            updateModelMonitor: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateModelMonitorResponse.decode.bind(updateModelMonitorResponse), updateModelMonitorMetadata.decode.bind(updateModelMonitorMetadata)),
            deleteModelMonitor: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteModelMonitorResponse.decode.bind(deleteModelMonitorResponse), deleteModelMonitorMetadata.decode.bind(deleteModelMonitorMetadata)),
            deleteModelMonitoringJob: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteModelMonitoringJobResponse.decode.bind(deleteModelMonitoringJobResponse), deleteModelMonitoringJobMetadata.decode.bind(deleteModelMonitoringJobMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1beta1.ModelMonitoringService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.modelMonitoringServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1beta1.ModelMonitoringService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.aiplatform.v1beta1
                    .ModelMonitoringService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of modelMonitoringServiceStubMethods) {
            const callPromise = this.modelMonitoringServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getModelMonitor(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
    ...
    createModelMonitoringJob(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.createModelMonitoringJob(request, options, callback);
    }
    getModelMonitoringJob(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.getModelMonitoringJob(request, options, callback);
    }
    createModelMonitor(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.createModelMonitor(request, options, callback);
    }
    /**
     ...
     */
    async checkCreateModelMonitorProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.createModelMonitor, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
    updateModelMonitor(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'model_monitor.name': (_a = request.modelMonitor.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.updateModelMonitor(request, options, callback);
    }
    /**
     ...
     */
    async checkUpdateModelMonitorProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.updateModelMonitor, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
    deleteModelMonitor(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.deleteModelMonitor(request, options, callback);
    }
    /**
     ...
     */
    async checkDeleteModelMonitorProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.deleteModelMonitor, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
    deleteModelMonitoringJob(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.deleteModelMonitoringJob(request, options, callback);
    }
    /**
     ...
     */
    async checkDeleteModelMonitoringJobProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.deleteModelMonitoringJob, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
    listModelMonitors(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.listModelMonitors(request, options, callback);
    }
    /**
    ...
    listModelMonitorsStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listModelMonitors.createStream(this.innerApiCalls.listModelMonitors, request, callSettings);
    }
    /**
    ...
    listModelMonitorsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listModelMonitors.asyncIterate(this.innerApiCalls['listModelMonitors'], request, callSettings);
    }
    listModelMonitoringJobs(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.listModelMonitoringJobs(request, options, callback);
    }
    /**
     * Equivalent to `method.name.toCamelCase()`, but returns a NodeJS Stream object.
     * @param {Object} request
    ...
    listModelMonitoringJobsStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listModelMonitoringJobs.createStream(this.innerApiCalls.listModelMonitoringJobs, request, callSettings);
    }
    /**
    ...
    listModelMonitoringJobsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listModelMonitoringJobs.asyncIterate(this.innerApiCalls['listModelMonitoringJobs'], request, callSettings);
    }
    searchModelMonitoringStats(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                model_monitor: (_a = request.modelMonitor) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.searchModelMonitoringStats(request, options, callback);
    }
    /**
     * Equivalent to `method.name.toCamelCase()`, but returns a NodeJS Stream object.
     * @param {Object} request
    ...
    searchModelMonitoringStatsStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.searchModelMonitoringStats.createStream(this.innerApiCalls.searchModelMonitoringStats, request, callSettings);
    }
    /**
    ...
    searchModelMonitoringStatsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.searchModelMonitoringStats.asyncIterate(this.innerApiCalls['searchModelMonitoringStats'], request, callSettings);
    }
    searchModelMonitoringAlerts(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.searchModelMonitoringAlerts(request, options, callback);
    }
    /**
     * Equivalent to `method.name.toCamelCase()`, but returns a NodeJS Stream object.
     * @param {Object} request
    ...
    searchModelMonitoringAlertsStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.searchModelMonitoringAlerts.createStream(this.innerApiCalls.searchModelMonitoringAlerts, request, callSettings);
    }
    /**
    ...
    searchModelMonitoringAlertsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.searchModelMonitoringAlerts.asyncIterate(this.innerApiCalls['searchModelMonitoringAlerts'], request, callSettings);
    }
    /**
...
exports.ModelMonitoringServiceClient = ModelMonitoringServiceClient;
//# sourceMappingURL=model_monitoring_service_client.js.map