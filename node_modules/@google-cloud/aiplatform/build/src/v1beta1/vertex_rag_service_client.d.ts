 ...
 * @memberof v1beta1
 */
export declare class VertexRagServiceClient {
    private _terminated;
    private _opts;
    ...
    vertexRagServiceStub?: Promise<{
        [name: string]: Function;
    }>;
    /**
     * Construct an instance of VertexRagServiceClient.
     *
     ...
     *     const client = new VertexRagServiceClient({fallback: true}, gax);
     *     ```
     */
     ...
     * @param {google.cloud.aiplatform.v1beta1.RetrieveContextsRequest.VertexRagStore} request.vertexRagStore
     ...
     * @param {google.cloud.aiplatform.v1beta1.RagQuery} request.query
     *   Required. Single RAG retrieve query.
     * @param {object} [options]
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Promise} - The promise which resolves to an array.
     *   The first element of the array is an object representing {@link protos.google.cloud.aiplatform.v1beta1.RetrieveContextsResponse|RetrieveContextsResponse}.
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v1beta1/vertex_rag_service.retrieve_contexts.js</caption>
     * region_tag:aiplatform_v1beta1_generated_VertexRagService_RetrieveContexts_async
     */
    retrieveContexts(request?: protos.google.cloud.aiplatform.v1beta1.IRetrieveContextsRequest, options?: CallOptions): Promise<[
        protos.google.cloud.aiplatform.v1beta1.IRetrieveContextsResponse,
        (protos.google.cloud.aiplatform.v1beta1.IRetrieveContextsRequest | undefined),
        {} | undefined
    ]>;
    retrieveContexts(request: protos.google.cloud.aiplatform.v1beta1.IRetrieveContextsRequest, options: CallOptions, callback: Callback<protos.google.cloud.aiplatform.v1beta1.IRetrieveContextsResponse, protos.google.cloud.aiplatform.v1beta1.IRetrieveContextsRequest | null | undefined, {} | null | undefined>): void;
    retrieveContexts(request: protos.google.cloud.aiplatform.v1beta1.IRetrieveContextsRequest, callback: Callback<protos.google.cloud.aiplatform.v1beta1.IRetrieveContextsResponse, protos.google.cloud.aiplatform.v1beta1.IRetrieveContextsRequest | null | undefined, {} | null | undefined>): void;
    /**
