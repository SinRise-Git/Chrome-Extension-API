...
exports.ReasoningEngineServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta1/reasoning_engine_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./reasoning_engine_service_client_config.json");
 ...
 * @memberof v1beta1
 */
class ReasoningEngineServiceClient {
    /**
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listReasoningEngines: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'reasoningEngines'),
        };
        ...
        const createReasoningEngineResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.ReasoningEngine');
        const createReasoningEngineMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.CreateReasoningEngineOperationMetadata');
        const deleteReasoningEngineResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteReasoningEngineMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeleteOperationMetadata');
        this.descriptors.longrunning = {
            createReasoningEngine: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createReasoningEngineResponse.decode.bind(createReasoningEngineResponse), createReasoningEngineMetadata.decode.bind(createReasoningEngineMetadata)),
            deleteReasoningEngine: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteReasoningEngineResponse.decode.bind(deleteReasoningEngineResponse), deleteReasoningEngineMetadata.decode.bind(deleteReasoningEngineMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1beta1.ReasoningEngineService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.reasoningEngineServiceStub) {
            return this.reasoningEngineServiceStub;
        }
        // Put together the "service stub" for
        // google.cloud.aiplatform.v1beta1.ReasoningEngineService.
        this.reasoningEngineServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1beta1.ReasoningEngineService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.aiplatform.v1beta1
                    .ReasoningEngineService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const reasoningEngineServiceStubMethods = [
        ...
        for (const methodName of reasoningEngineServiceStubMethods) {
            const callPromise = this.reasoningEngineServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getReasoningEngine(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
    ...
    createReasoningEngine(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkCreateReasoningEngineProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.createReasoningEngine, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
    deleteReasoningEngine(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkDeleteReasoningEngineProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.deleteReasoningEngine, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
    listReasoningEngines(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     *   for more details and examples.
     */
    listReasoningEnginesStream(request, options) {
        var _a;
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        ...
        this.initialize();
        return this.descriptors.page.listReasoningEngines.createStream(this.innerApiCalls.listReasoningEngines, request, callSettings);
    }
    /**
     ...
     */
    listReasoningEnginesAsync(request, options) {
        var _a;
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listReasoningEngines.asyncIterate(this.innerApiCalls['listReasoningEngines'], request, callSettings);
    }
    /**
...
//# sourceMappingURL=reasoning_engine_service_client.js.map