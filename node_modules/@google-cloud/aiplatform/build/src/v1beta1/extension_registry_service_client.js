...
exports.ExtensionRegistryServiceClient = void 0;
 ...
 */
const gapicConfig = require("./extension_registry_service_client_config.json");
 ...
 * @memberof v1beta1
 */
class ExtensionRegistryServiceClient {
    /**
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listExtensions: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'extensions'),
        };
        ...
        const importExtensionResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.Extension');
        const importExtensionMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.ImportExtensionOperationMetadata');
        const deleteExtensionResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteExtensionMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeleteOperationMetadata');
        this.descriptors.longrunning = {
            importExtension: new this._gaxModule.LongrunningDescriptor(this.operationsClient, importExtensionResponse.decode.bind(importExtensionResponse), importExtensionMetadata.decode.bind(importExtensionMetadata)),
            deleteExtension: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteExtensionResponse.decode.bind(deleteExtensionResponse), deleteExtensionMetadata.decode.bind(deleteExtensionMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1beta1.ExtensionRegistryService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.extensionRegistryServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1beta1.ExtensionRegistryService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.aiplatform.v1beta1
                    .ExtensionRegistryService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of extensionRegistryServiceStubMethods) {
            const callPromise = this.extensionRegistryServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getExtension(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
    ...
    updateExtension(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'extension.name': (_a = request.extension.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.updateExtension(request, options, callback);
    }
    importExtension(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkImportExtensionProgress(name) {
    ...
    deleteExtension(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkDeleteExtensionProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
    ...
    listExtensions(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     *   for more details and examples.
     */
    listExtensionsStream(request, options) {
        var _a;
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        ...
        this.initialize();
        return this.descriptors.page.listExtensions.createStream(this.innerApiCalls.listExtensions, request, callSettings);
    }
    /**
     ...
     */
    listExtensionsAsync(request, options) {
        var _a;
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listExtensions.asyncIterate(this.innerApiCalls['listExtensions'], request, callSettings);
    }
    /**
     ...
     */
    close() {
        if (this.extensionRegistryServiceStub && !this._terminated) {
            return this.extensionRegistryServiceStub.then(stub => {
...
exports.ExtensionRegistryServiceClient = ExtensionRegistryServiceClient;
//# sourceMappingURL=extension_registry_service_client.js.map