...
export declare class FeaturestoreOnlineServingServiceClient {
     ...
     */
    readFeatureValues(request?: protos.google.cloud.aiplatform.v1beta1.IReadFeatureValuesRequest, options?: CallOptions): Promise<[
    ...
    readFeatureValues(request: protos.google.cloud.aiplatform.v1beta1.IReadFeatureValuesRequest, options: CallOptions, callback: Callback<protos.google.cloud.aiplatform.v1beta1.IReadFeatureValuesResponse, protos.google.cloud.aiplatform.v1beta1.IReadFeatureValuesRequest | null | undefined, {} | null | undefined>): void;
    readFeatureValues(request: protos.google.cloud.aiplatform.v1beta1.IReadFeatureValuesRequest, callback: Callback<protos.google.cloud.aiplatform.v1beta1.IReadFeatureValuesResponse, protos.google.cloud.aiplatform.v1beta1.IReadFeatureValuesRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     */
    writeFeatureValues(request?: protos.google.cloud.aiplatform.v1beta1.IWriteFeatureValuesRequest, options?: CallOptions): Promise<[
    ...
    writeFeatureValues(request: protos.google.cloud.aiplatform.v1beta1.IWriteFeatureValuesRequest, options: CallOptions, callback: Callback<protos.google.cloud.aiplatform.v1beta1.IWriteFeatureValuesResponse, protos.google.cloud.aiplatform.v1beta1.IWriteFeatureValuesRequest | null | undefined, {} | null | undefined>): void;
    writeFeatureValues(request: protos.google.cloud.aiplatform.v1beta1.IWriteFeatureValuesRequest, callback: Callback<protos.google.cloud.aiplatform.v1beta1.IWriteFeatureValuesResponse, protos.google.cloud.aiplatform.v1beta1.IWriteFeatureValuesRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     */
    streamingReadFeatureValues(request?: protos.google.cloud.aiplatform.v1beta1.IStreamingReadFeatureValuesRequest, options?: CallOptions): gax.CancellableStream;
    /**
