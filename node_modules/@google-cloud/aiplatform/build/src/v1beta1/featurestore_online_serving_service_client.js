 ...
 * `src/v1beta1/featurestore_online_serving_service_client_config.json`.
...
class FeaturestoreOnlineServingServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1beta1.FeaturestoreOnlineServingService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.featurestoreOnlineServingServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1beta1.FeaturestoreOnlineServingService')
