...
class NotebookServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createNotebookRuntimeTemplateResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.NotebookRuntimeTemplate');
        const createNotebookRuntimeTemplateMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.CreateNotebookRuntimeTemplateOperationMetadata');
        const deleteNotebookRuntimeTemplateResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteNotebookRuntimeTemplateMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeleteOperationMetadata');
        const assignNotebookRuntimeResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.NotebookRuntime');
        const assignNotebookRuntimeMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.AssignNotebookRuntimeOperationMetadata');
        const deleteNotebookRuntimeResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteNotebookRuntimeMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.DeleteOperationMetadata');
        const upgradeNotebookRuntimeResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.UpgradeNotebookRuntimeResponse');
        const upgradeNotebookRuntimeMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.UpgradeNotebookRuntimeOperationMetadata');
        const startNotebookRuntimeResponse = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.StartNotebookRuntimeResponse');
        const startNotebookRuntimeMetadata = protoFilesRoot.lookup('.google.cloud.aiplatform.v1beta1.StartNotebookRuntimeOperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1beta1.NotebookService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.notebookServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1beta1.NotebookService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.aiplatform.v1beta1.NotebookService, this._opts, this._providedCustomServicePath);
