...
exports.VertexRagServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta1/vertex_rag_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./vertex_rag_service_client_config.json");
...
class VertexRagServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1beta1.VertexRagService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.vertexRagServiceStub) {
            return this.vertexRagServiceStub;
        }
        // Put together the "service stub" for
        // google.cloud.aiplatform.v1beta1.VertexRagService.
        this.vertexRagServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1beta1.VertexRagService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.aiplatform.v1beta1
                    .VertexRagService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const vertexRagServiceStubMethods = ['retrieveContexts'];
        for (const methodName of vertexRagServiceStubMethods) {
            const callPromise = this.vertexRagServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    retrieveContexts(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
...
//# sourceMappingURL=vertex_rag_service_client.js.map