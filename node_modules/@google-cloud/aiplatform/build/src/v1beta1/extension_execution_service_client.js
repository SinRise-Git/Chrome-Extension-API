...
exports.ExtensionExecutionServiceClient = void 0;
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v1beta1/extension_execution_service_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./extension_execution_service_client_config.json");
 ...
 * @memberof v1beta1
 */
class ExtensionExecutionServiceClient {
    /**
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.aiplatform.v1beta1.ExtensionExecutionService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.extensionExecutionServiceStub) {
            return this.extensionExecutionServiceStub;
        }
        // Put together the "service stub" for
        // google.cloud.aiplatform.v1beta1.ExtensionExecutionService.
        this.extensionExecutionServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.aiplatform.v1beta1.ExtensionExecutionService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.aiplatform.v1beta1
                    .ExtensionExecutionService, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const extensionExecutionServiceStubMethods = [
            'executeExtension',
            'queryExtension',
        ];
        for (const methodName of extensionExecutionServiceStubMethods) {
            const callPromise = this.extensionExecutionServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    executeExtension(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.executeExtension(request, options, callback);
    }
    queryExtension(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.queryExtension(request, options, callback);
    }
    /**
     ...
     */
    close() {
        if (this.extensionExecutionServiceStub && !this._terminated) {
            return this.extensionExecutionServiceStub.then(stub => {
...
exports.ExtensionExecutionServiceClient = ExtensionExecutionServiceClient;
//# sourceMappingURL=extension_execution_service_client.js.map